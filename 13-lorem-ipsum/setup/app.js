...
//selecting form, amount = result,result = paragraph
...
form.addEventListener("submit", function (e) {
  e.preventDefault();
  // doesn't' disappear on the server
  const value = parseInt(amount.value);
  //now the number is a string -> add parseInt; console -> should be blue
  ...
  if (isNaN(value) || value < 0 || value > 9) {
    ...
    // if a user doesn't inter any value
  } else {
